...
class Config(object):
    ...
    def __init__(self, model_name, num_layers, num_graphs, merge_function, zero_shot):
        ...
        self.annot_path = '/project/DALY/' 
        self.data_path = '/project/DALY/extracted_frames_cr_with_fps_all_videos_224_224/'        
        self.results_path = '/project/results'
        self.scores_path = '/project/scores'
        self.am_path = '/project/am'
        self.features_path = '/project/features'
        self.i3d_weights_path = '/project/code'
        self.filename = ''
        ...
        self.start_epoch = 0
        self.total_epochs = 450 # 'total_steps' is inferred as (per epoch) 'num_steps' * 'total_epochs'
        self.warmup_epochs = 0 # 'warmup_steps' is inferred as (per epoch) 'num_steps' * 'warmup_epochs' (0-indexed)
        self.init_lr = 4.5e-6
        self.max_lr = 4.7e-5
        self.min_lr = 0
        ...
        self.save_scores = True # whether to save output (softmax) scores every x-number of epochs
        self.save_am = True # whether to save the adjacency matrix of every clip
        if self.model_name == 'baseline':
            self.save_am = False
        self.plot_grad_flow = True
        self.num_epochs_to_val = 10
        
        self.load_checkpoint = False # Load weights from checkpoint and resume training
