...
def split_train_val(write_to_pkl=False):
    ...
    if write_to_pkl:
        with open('/project/DALY/training_videos.pkl', 'wb') as f:
            pickle.dump(training_videos, f)
        with open('/project/DALY/validation_videos.pkl', 'wb') as f:
            pickle.dump(validation_videos, f)
        with open('/project/DALY/all_training_videos.pkl', 'wb') as f:
