...
parse.add_argument('-cp', '--config_path', help='Path to model\'s config file; required for inference')
...
parser.add_argument('-mcp', '--model_checkpoint_path', help='Path to model\'s saved weights (model checkpoint); required for inference')
